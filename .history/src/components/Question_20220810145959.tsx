            ...
            <div className="question-cxt-option">
                {
                    item.options?.length > 0 && item.options.map((option:string,oIdx:number)=>(
                        <div className={ active ? (
                            currentAns === item.oIdx ? "question-cxt-option-item-active":"question-cxt-option-item"
                        ):(
                            currentAns === item.answer ? "question-cxt-option-item-correct":"question-cxt-option-item"
                        )
